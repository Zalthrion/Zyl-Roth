...
// TODO Check mappings and reorganize methods
public class TileEntityBase extends TileEntity implements IInventory {
	...
	@Override public ItemStack removeStackFromSlot(int p_70304_1_) {
		return null;
	}
	
	@Override public void setInventorySlotContents(int p_70299_1_, ItemStack itemStack) {
