...
public class EntityPyroKnight extends EntityMob implements IBossDisplayData {
	...
	public EntityPyroKnight(World world) {
		...
		this.setCurrentItemOrArmor(4, new ItemStack(ModArmors.VoidLord_Helmet));
		this.setCurrentItemOrArmor(3, new ItemStack(ModArmors.VoidLord_Chestplate));
		this.setCurrentItemOrArmor(2, new ItemStack(ModArmors.VoidLord_Leggings));
		this.setCurrentItemOrArmor(1, new ItemStack(ModArmors.VoidLord_Boots));
	}
