...
//TODO: Copy of EntityAIMate, modified to allow animals to mate other animals.
public class EntityAIMateAnimals extends EntityAIBase
{
    ...
    {
        float f = 8.0F;
        List list = this.theWorld.getEntitiesWithinAABB(EntityAnimal.class, this.theAnimal.boundingBox.expand((double)f, (double)f, (double)f));
