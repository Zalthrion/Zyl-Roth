...
public class EntityAIMateAnimals extends EntityAIBase {
	...
	public EntityAIMateAnimals(EntityAnimal animal, double speedIn) {
	...
	private EntityAnimal getNearbyMate() {
		List<EntityAnimal> list = this.theWorld.<EntityAnimal> getEntitiesWithinAABB(EntityAnimal.class, this.theAnimal.getEntityBoundingBox().expandXyz(8.0D));
