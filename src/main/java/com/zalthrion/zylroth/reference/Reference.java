...
public class Reference {
	...
	public static final String LOWER_MOD_ID = MOD_ID.toLowerCase();
	public static final String RESOURCE_PREFIX = LOWER_MOD_ID + ":";
	public static final String TOOLTIP_PREFIX = "tooltip." + RESOURCE_PREFIX;
