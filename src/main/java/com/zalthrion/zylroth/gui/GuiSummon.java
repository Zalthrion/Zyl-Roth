...
public class GuiSummon extends GuiScreen {
	...
	@Override public void initGui() {
		...
		GuiButton initialButton = new GuiButton(0, xPos + 25, yPos, 100, 20, I18n.format("entity.Zylroth:Deathcharger.name"));
		initialButton.enabled = false;
		this.buttonList.add(initialButton);
		this.buttonList.add(new GuiButton(1, xPos + 25, yPos + 25, 100, 20, I18n.format("entity.Zylroth:Plagued_Horse.name")));
		this.buttonList.add(new GuiButton(2, xPos + 25, yPos + 50, 100, 20, I18n.format("entity.Zylroth:SavageBadger.name")));
		this.buttonList.add(new GuiButton(3, xPos + 25, yPos + 75, 100, 20, I18n.format("entity.Zylroth:SwiftUnicorn.name")));
		this.buttonList.add(new GuiButton(4, xPos + 25, yPos + 100, 100, 20, I18n.format("entity.Zylroth:WarTortoise.name")));
		this.buttonList.add(new SummonDismissButton(this.summons, xPos + 150, yPos + 100, 100, 20, I18n.format("gui.zylroth:summon")));
