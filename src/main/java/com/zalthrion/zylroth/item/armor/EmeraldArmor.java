...
public class EmeraldArmor extends ItemBaseArmor {
	
	private String name = "emeraldArmor";
	
	private String textureName;
	
	public EmeraldArmor(ArmorMaterial armorMaterial, String textureName, int type) {
