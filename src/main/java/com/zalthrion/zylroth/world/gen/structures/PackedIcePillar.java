...
public class PackedIcePillar extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		world.setBlock(x + 0, y + 1, z + 0, Blocks.packed_ice, 0, 0);
		
		world.setBlock(x + 1, y + 1, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 0, y + 1, z + 1, Blocks.packed_ice, 0, 0);
		world.setBlock(x + -1, y + 1, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 0, y + 1, z - 1, Blocks.packed_ice, 0, 0);
		
		world.setBlock(x - 1, y + 1, z - 1, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 1, y + 1, z + 1, Blocks.packed_ice, 0, 0);
		
		world.setBlock(x + 2, y + 1, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x - 2, y + 1, z + 0, Blocks.packed_ice, 0, 0);
		...
		world.setBlock(x - 1, y + 2, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x - 2, y + 2, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 0, y + 2, z + 1, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 0, y + 2, z + 2, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 1, y + 2, z + 1, Blocks.packed_ice, 0, 0);
		world.setBlock(x - 1, y + 2, z + 1, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 0, y + 2, z - 1, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 1, y + 2, z - 1, Blocks.packed_ice, 0, 0);
		world.setBlock(x - 1, y + 2, z - 1, Blocks.packed_ice, 0, 0);
		...
		world.setBlock(x + 0, y + 3, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x + 1, y + 3, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x - 1, y + 3, z + 0, Blocks.packed_ice, 0, 0);
		world.setBlock(x - 2, y + 3, z + 0, Blocks.packed_ice, 0, 0);
