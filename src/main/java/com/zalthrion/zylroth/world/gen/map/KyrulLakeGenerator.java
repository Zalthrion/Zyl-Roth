...
public class KyrulLakeGenerator extends WorldGenerator {
	private Block field_150556_a;
	
	public KyrulLakeGenerator(Block p_i45455_1_) {
				...
				for (j2 = 0; j2 < 16; ++ j2) {
					for (j1 = 0; j1 < 8; ++ j1) {
						...
						if (flag) {
							...
							if (j1 >= 4 && material.isLiquid()) { return false; }
							
							if (j1 < 4 && !material.isSolid() && p_76484_1_.getBlock(p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2) != this.field_150556_a) { return false; }
						}
					}
				}
			}
					...
					for (j2 = 0; j2 < 16; ++ j2) {
						for (j1 = 0; j1 < 8; ++ j1) {
							...
							if (flag && (j1 < 4 || p_76484_2_.nextInt(2) != 0) && p_76484_1_.getBlock(p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2).getMaterial().isSolid()) {
								p_76484_1_.setBlock(p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2, ModBlocks.voidStone, 0, 2);
							}
						}
					}
				}
