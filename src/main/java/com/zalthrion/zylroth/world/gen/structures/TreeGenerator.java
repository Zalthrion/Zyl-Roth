...
public class TreeGenerator extends WorldGenAbstractTree {
	...
	public TreeGenerator(boolean doBlockNotify, int minHeight, Block wood, Block leaves, int woodMeta, int leavesMeta, boolean vines) {
		super(doBlockNotify);
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		int l = rand.nextInt(3) + minTreeHeight;
		boolean flag = true;
				...
				if (isSoil && y < 256 - l - 1) {
							...
							for (int k2 = z - l1; k2 <= z + l1; ++ k2) {
								...
								if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || rand.nextInt(2) != 0 && i3 != 0) {
									...
									if (block1.isAir(world, i2, k1, k2) || block1.isLeaves(world, i2, k1, k2)) {
										this.setBlockAndNotifyAdequately(world, i2, k1, k2, leafBlock, metaLeaves);
									}
								}
							}
						}
					...
					for (k1 = 0; k1 < l; ++ k1) {
						...
						if (block.isAir(world, x, y + k1, z) || block.isLeaves(world, x, y + k1, z)) {
							this.setBlockAndNotifyAdequately(world, x, y + k1, z, woodBlock, metaWood);
	...
	private void growVines(World p_76529_1_, int p_76529_2_, int p_76529_3_, int p_76529_4_, int p_76529_5_) {
		...
		while (true) {
			...
			if (!p_76529_1_.getBlock(p_76529_2_, p_76529_3_, p_76529_4_).isAir(p_76529_1_, p_76529_2_, p_76529_3_, p_76529_4_) || i1 <= 0) { return; }
