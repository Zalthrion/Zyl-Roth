...
public class DragonNest extends WorldGenerator implements IWorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		if (!locationIsValidSpawn(world, i, j, k) || !locationIsValidSpawn(world, i + 6, j, k) || !locationIsValidSpawn(world, i + 6, j, k + 6) || !locationIsValidSpawn(world, i, j, k + 6)) { return false; }
