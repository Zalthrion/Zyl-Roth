...
public class DragonNest extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		if (!locationIsValidSpawn(world, x, y, z) || !locationIsValidSpawn(world, x - 3, y + 1, z - 2) || !locationIsValidSpawn(world, x - 3, y + 1, z - 1) || !locationIsValidSpawn(world, x - 3, y + 1, z + 0) || !locationIsValidSpawn(world, x - 3, y + 1, z + 1) || !locationIsValidSpawn(world, x - 3, y + 1, z + 2) || !locationIsValidSpawn(world, x - 2, y + 1, z - 3) || !locationIsValidSpawn(world, x - 2, y + 1, z - 2) || !locationIsValidSpawn(world, x - 2, y + 1, z - 1) || !locationIsValidSpawn(world, x - 2, y + 1, z + 0) || !locationIsValidSpawn(world, x - 2, y + 1, z + 1) || !locationIsValidSpawn(world, x - 2, y + 1, z + 2) || !locationIsValidSpawn(world, x - 2, y + 1, z + 3) || !locationIsValidSpawn(world, x - 1, y + 1, z - 3) || !locationIsValidSpawn(world, x - 1, y + 1, z - 2) || !locationIsValidSpawn(world, x - 1, y + 1, z - 1) || !locationIsValidSpawn(world, x - 1, y + 1, z + 0) || !locationIsValidSpawn(world, x - 1, y + 1, z + 1)
				|| !locationIsValidSpawn(world, x - 1, y + 1, z + 2) || !locationIsValidSpawn(world, x - 1, y + 1, z + 3) || !locationIsValidSpawn(world, x + 0, y + 1, z - 3) || !locationIsValidSpawn(world, x + 0, y + 1, z - 2) || !locationIsValidSpawn(world, x + 0, y + 1, z - 1)
				|| !locationIsValidSpawn(world, x + 0, y + 1, z + 0) // Central Block
				|| !locationIsValidSpawn(world, x + 0, y + 1, z + 1) || !locationIsValidSpawn(world, x + 0, y + 1, z + 2) || !locationIsValidSpawn(world, x + 0, y + 1, z + 3) || !locationIsValidSpawn(world, x + 1, y + 1, z - 3) || !locationIsValidSpawn(world, x + 1, y + 1, z - 2) || !locationIsValidSpawn(world, x + 1, y + 1, z - 1) || !locationIsValidSpawn(world, x + 1, y + 1, z + 0) || !locationIsValidSpawn(world, x + 1, y + 1, z + 1) || !locationIsValidSpawn(world, x + 1, y + 1, z + 2) || !locationIsValidSpawn(world, x + 1, y + 1, z + 3) || !locationIsValidSpawn(world, x + 2, y + 1, z - 3) || !locationIsValidSpawn(world, x + 2, y + 1, z - 2) || !locationIsValidSpawn(world, x + 2, y + 1, z - 1) || !locationIsValidSpawn(world, x + 2, y + 1, z + 0) || !locationIsValidSpawn(world, x + 2, y + 1, z + 1) || !locationIsValidSpawn(world, x + 2, y + 1, z + 2) || !locationIsValidSpawn(world, x + 2, y + 1, z + 3) || !locationIsValidSpawn(world, x + 3, y + 1, z - 2)
				|| !locationIsValidSpawn(world, x + 3, y + 1, z - 1) || !locationIsValidSpawn(world, x + 3, y + 1, z + 0) || !locationIsValidSpawn(world, x + 3, y + 1, z + 1) || !locationIsValidSpawn(world, x + 3, y + 1, z + 2)
