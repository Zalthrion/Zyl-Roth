...
public class DesertHouse extends WorldGenerator implements IWorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		if(!locationIsValidSpawn(world, i, j, k) || !locationIsValidSpawn(world, i + 5, j, k) || !locationIsValidSpawn(world, i + 5, j, k + 7) || !locationIsValidSpawn(world, i, j, k + 7))
		{
			return false;
		}
