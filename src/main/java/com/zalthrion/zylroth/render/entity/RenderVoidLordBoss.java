...
public class RenderVoidLordBoss extends RenderBiped {
	private static final ResourceLocation pyroknightTextures = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entities/Undead_Unit_2.png");
	
	/** Scale of the model to use */
	private float scale = 1.1F;
	
	public RenderVoidLordBoss(ModelBiped model, float shadowSize) {
