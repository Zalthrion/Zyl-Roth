...
public class RenderUnicorn extends RenderLiving {
	 ...
	 */
	protected void preRenderCallback(EntityUnicorn p_77041_1_, float p_77041_2_) {
		float f1 = 1.0F;
	 ...
	 */
	protected void renderModel(EntityUnicorn p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityUnicorn p_110775_1_) {
	...
	protected void preRenderCallback(EntityLivingBase p_77041_1_, float p_77041_2_) {
		this.preRenderCallback((EntityUnicorn) p_77041_1_, p_77041_2_);
	}
	...
	protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
		this.renderModel((EntityUnicorn) p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
	}
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return this.getEntityTexture((EntityUnicorn) p_110775_1_);
	}
}