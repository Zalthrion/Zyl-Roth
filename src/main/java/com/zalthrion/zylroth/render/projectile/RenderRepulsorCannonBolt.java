...
public class RenderRepulsorCannonBolt extends Render {
	...
	public RenderRepulsorCannonBolt(ModelBase model) {
		super();
	}
	
	/** Returns the location of an entity's texture. Doesn't seem to be called
	 * unless you call Render.bindEntityTexture. */
	protected ResourceLocation getEntityTexture(RepulsorCannonBolt projectile) {
	 ...
	 */
	public void doRender(RepulsorCannonBolt entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		GL11.glPushMatrix();
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return this.getEntityTexture((RepulsorCannonBolt) entity);
	}
	...
	public void doRender(Entity entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		this.doRender((RepulsorCannonBolt) entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
}
