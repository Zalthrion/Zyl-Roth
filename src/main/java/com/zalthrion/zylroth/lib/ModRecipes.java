...
public final class ModRecipes {
	...
	public static void registerShapedRecipes() {
		...
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.tenebrae_Core), "DED", "DCD", "DED", 'D', Items.diamond, 'E', ModItems.soul_Essence, 'C', ModItems.unstable_Tenebrae_Core);
