...
public class RainbowLeafBlock extends BlockLeaves {
	...
	public IIcon getIcon(int side, int meta) {
		...
		return (meta & 3) == 1 ? this.icon[this.field_150127_b][1] : ((meta & 3) == 2 ? this.icon[this.field_150127_b][2] : ((meta & 3) == 3 ? this.icon[this.field_150127_b][3] : this.icon[this.field_150127_b][0]));
	}
