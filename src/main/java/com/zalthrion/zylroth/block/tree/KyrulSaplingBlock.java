...
public class KyrulSaplingBlock extends BlockBush implements IGrowable {
	...
	public static final String[] sapling_names = new String[] {"voidTreeSapling"};
	...
	public IIcon getIcon(int side, int meta) {
		meta &= 7;
		return icon[MathHelper.clamp_int(meta, 0, 3)];
	}
	...
	public void growTree(World world, int x, int y, int z, Random rand) {
		...
		switch (l) {
			case 0:
				object = new TreeGenerator(true, 4, ModBlocks.kyrulLogBlock, ModBlocks.kyrulLeafBlock, 0, 0, false);
				break;
			case 1:
				break;
			case 2:
