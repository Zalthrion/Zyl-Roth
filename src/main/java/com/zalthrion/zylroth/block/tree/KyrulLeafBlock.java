...
public class KyrulLeafBlock extends BlockLeaves {
	...
	public static final String[][] leaf_names = new String[][] { {"voidTreeLeaves"}, {"voidTreeLeaves_opaque"}};
	public static final String[] leaf_types = new String[] {"voidTree"};
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.kyrulSaplingBlock);
	}
