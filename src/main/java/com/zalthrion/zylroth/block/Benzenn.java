...
public class Benzenn extends BlockBaseContainer {
	private String name = "benzenn";
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase placer, ItemStack stack) {
		...
		if (tileentity instanceof TileEntityBenzenn) {
			((TileEntityBenzenn) tileentity).setFacing(facing);
