...
public class ModelVoidLordArmor extends ModelBiped {
    ...
    public ModelVoidLordArmor() {
        ...
        this.RightShoulderpadBorder3.setRotationPoint(0.0F, -1.15F, 2.77F);
        ...
        this.ChestplateBack.setRotationPoint(1.0F, 1.6F, 3.5F);
        ...
        this.ChestplateFront.setRotationPoint(1.0F, 1.6F, -1.5F);
        ...
        this.RightTopHorn.setRotationPoint(-8.5F, -9.42F, -0.5F);
        ...
        this.LeftBottomHorn.setRotationPoint(4.5F, -5.8F, -0.5F);
        this.LeftBottomHorn.addBox(0.0F, 0.0F, 0.0F, 4, 2, 2, 0.0F);
        ...
        this.RightBottomHorn.setRotationPoint(-7.5F, -6.42F, -0.5F);
