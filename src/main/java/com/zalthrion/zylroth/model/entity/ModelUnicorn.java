...
@SideOnly(Side.CLIENT) public class ModelUnicorn extends ModelBase {
	...
	public ModelRenderer Horn_Bottom;
	public ModelRenderer Horn_Center;
	public ModelRenderer Horn_Top;
	...
	public ModelUnicorn() {
		...
		this.Horn_Top = new ModelRenderer(this, 100, 65);
		this.Horn_Top.setRotationPoint(2.0F, -7.5F, 8.0F);
		this.Horn_Top.addBox(-2.5F, -10.1F, -7.0F, 1, 5, 1, 0.0F);
		
		this.Horn_Center = new ModelRenderer(this, 80, 70);
		this.Horn_Center.setRotationPoint(1.5F, -5.0F, 7.5F);
		this.Horn_Center.addBox(-2.5F, -10.1F, -7.0F, 2, 5, 2, 0.0F);
		
		this.Horn_Bottom = new ModelRenderer(this, 80, 60);
		this.Horn_Bottom.setRotationPoint(1.0F, -2.0F, 7.0F);
		this.Horn_Bottom.addBox(-2.5F, -10.1F, -7.0F, 3, 2, 3, 0.0F);
		
		this.head.addChild(this.Horn_Top);
		this.head.addChild(this.Horn_Center);
		this.head.addChild(this.Horn_Bottom);
	}
	...
	@Override public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
		...
		HorseType horsearmortype = entityhorse.getType();
