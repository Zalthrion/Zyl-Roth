...
@SideOnly(Side.CLIENT) public class ModelVoidDragon extends ModelBase {
	...
	public ModelVoidDragon(float par1) {
		textureWidth = 256;
		textureHeight = 256;
	...
	@Override public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7) {
		...
		EntityVoidDragon entitydragon = (EntityVoidDragon) par1Entity;
		...
		GlStateManager.translate(0, f7 - 2, -3);
		GlStateManager.rotate(f7 * 2, 1, 0, 0);
		float f8 = -30.0F;
		float f9 = 0.0F;
		float f10 = 1.5F;
		...
		GlStateManager.rotate(-f11 * f10 * 1, 0, 0, 1);
		GlStateManager.translate(0, -1, 0);
