...
@SideOnly(Side.CLIENT) public class ModelTenebraeGolem extends ModelBase {
	...
	public ModelTenebraeGolem() {
		this(0.0F);
	}
	
	public ModelTenebraeGolem(float par1) {
		this(par1, -7.0F);
	}
	
	public ModelTenebraeGolem(float par1, float par2) {
		short short1 = 128;
		short short2 = 128;
	...
	public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4) {
		EntityTenebraeGolem entitytenebrae_golem = (EntityTenebraeGolem) par1EntityLivingBase;
		int i = entitytenebrae_golem.getAttackTimer();
