...
public class ModelInfuser extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(this.TopI.offsetX, this.TopI.offsetY, this.TopI.offsetZ);
        GL11.glTranslatef(this.TopI.rotationPointX * f5, this.TopI.rotationPointY * f5, this.TopI.rotationPointZ * f5);
