...
public class ModelGoldBag extends ModelBase {
    ...
    public ModelGoldBag() {
        ...
        this.shape1_7.setRotationPoint(1.0F, -1.5F, 7.5F);
        this.shape1_7.addBox(0.0F, 0.0F, 0.0F, 7, 2, 1, 0.0F);
        this.shape1_8 = new ModelRenderer(this, 47, 18);
        this.shape1_8.setRotationPoint(7.0F, -1.5F, 1.0F);
        ...
        this.shape1_6.setRotationPoint(1.0F, -1.5F, 0.5F);
        this.shape1_6.addBox(0.0F, 0.0F, 0.0F, 7, 2, 1, 0.0F);
        this.shape1_9 = new ModelRenderer(this, 47, 18);
        this.shape1_9.setRotationPoint(1.0F, -1.5F, 1.0F);
